...
class WebScraper:
    ...
    def scraping(self):
        """ 
            ...
            1. access() - Webページにアクセス
            2. web_driver_wait() - ページ読み込み待機
            3. parse_html() - HTML解析
            4. extract() - 必要なデータ抽出
...
if __name__ == '__main__':
    ...
    # csv,スプレッドシートid,JSONファイル。google_spreadsheet_idとservice_account_jsonのfallbackはダミー
